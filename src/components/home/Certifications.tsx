...
export function Certifications() {
  return (
    <Section
      eyebrow="Credentials"
      title="Partner status and certifications"
      description="Microsoft Launch Partner membership plus current CompTIA and operations credentials aligned with the work we deliver."
    >
